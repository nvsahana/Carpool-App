            ...
            <div className="hero-content">
                ...
                <div className="features-container">
                    ...
                    <div className="feature-card">
                        ...
                        <h3 className="feature-title">Find Your Ride</h3>
                        <p className="feature-text">
                            Discover people heading to the same destination and share the journey together
                        </p>
                    </div>
                    ...
                    <div className="feature-card">
                        ...
                        <h3 className="feature-title">Save Money</h3>
                        <p className="feature-text">
                            Split costs and reduce your commute expenses while helping the environment
                        </p>
                    </div>
                    ...
                    <div className="feature-card">
                        ...
                        <h3 className="feature-title">Go Green</h3>
                        <p className="feature-text">
                            Reduce carbon footprint by sharing rides and making a positive impact
                        </p>
                    </div>
                </div>
