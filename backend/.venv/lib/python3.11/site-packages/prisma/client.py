...
SCHEMA_PATH = Path('/Users/sahana/Desktop/GithubPorfolioProject/Carpool-App/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/sahana/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    companyaddress: 'actions.CompanyAddressActions[models.CompanyAddress]'
    homeaddress: 'actions.HomeAddressActions[models.HomeAddress]'
    ...
    def __init__(
        ...
        *,
        ...
        self.companyaddress = actions.CompanyAddressActions[models.CompanyAddress](self, models.CompanyAddress)
        self.homeaddress = actions.HomeAddressActions[models.HomeAddress](self, models.HomeAddress)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/sahana/Desktop/GithubPorfolioProject/Carpool-App/backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    companyaddress: 'CompanyAddressBatchActions'
    homeaddress: 'HomeAddressBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.companyaddress = CompanyAddressBatchActions(self)
        self.homeaddress = HomeAddressBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class CompanyAddressBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
